...
var DateTimeShortcuts = {
    ...
    admin_media_prefix: '/appengine_admin_media/',
    init: function() {
...
//                DateTimeShortcuts.admin_media_prefix = scripts[i].src.substring(0, idx);
    ...
    addClock: function(inp) {
        ...
        quickElement('img', clock_link, '', 'src', DateTimeShortcuts.admin_media_prefix + 'images/icon_clock.gif', 'alt', 'Clock');
        ...
        quickElement("a", quickElement("li", time_list, ""), "Now", "href", "javascript:DateTimeShortcuts.handleClockQuicklink(" + num + ", new Date().getHourMinuteSecond());")
        quickElement("a", quickElement("li", time_list, ""), "Midnight", "href", "javascript:DateTimeShortcuts.handleClockQuicklink(" + num + ", '00:00:00');")
        quickElement("a", quickElement("li", time_list, ""), "6 a.m.", "href", "javascript:DateTimeShortcuts.handleClockQuicklink(" + num + ", '06:00:00');")
        quickElement("a", quickElement("li", time_list, ""), "Noon", "href", "javascript:DateTimeShortcuts.handleClockQuicklink(" + num + ", '12:00:00');")
    ...
    addCalendar: function(inp) {
        ...
        quickElement('img', cal_link, '', 'src', DateTimeShortcuts.admin_media_prefix + 'images/icon_calendar.gif', 'alt', 'Calendar');
        shortcuts_span.appendChild(document.createTextNode('\240'));
